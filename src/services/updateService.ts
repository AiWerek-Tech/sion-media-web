...
const fallbackLatestVersion: LatestVersionData = {
  ...
  notes: [
    'Presentation Bridge terbaru memakai SION PowerPoint Agent C#/.NET, binary frame transport, dan UI Bridge yang dipoles.',
    'Metadata rilis tidak dapat dimuat. Buka GitHub Releases untuk mengunduh installer terbaru.'
  ],
}
